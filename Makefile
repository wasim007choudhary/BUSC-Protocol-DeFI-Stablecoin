...
NETWORK_ARGS := --rpc-url http://localhost:8545 --private-key $(ANVIL_ANVIL_KEY) --broadcast
...
deploy-anvil:
	forge script script/DeployBUSC.s.sol:DeployBUSC --rpc-url $(ANVIL_RPC_URL) --private-key $(ANVIL_PRIVATE_KEY) --broadcast  -vvvv

deploy-sepolia:
	deploy-sepolia1: 
	@forge script script/DeployBUSC.s.sol:DeployBUSC \
